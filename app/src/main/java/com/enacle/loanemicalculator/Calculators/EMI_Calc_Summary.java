...
public class EMI_Calc_Summary extends AppCompatActivity {
    ...
    private void calculate(View view) {
        ...
        String formattedMonthlyEMI = formatter.format(monthlyEMI);
        String formattedTotalInterest = formatter.format(totalInterest);
        String formattedTotalPayment = formatter.format(totalPayment);

        // Display the formatted results
        edt_monthly_emi.setText(formattedMonthlyEMI);
        edt_t_interest.setText(formattedTotalInterest);
        edt_t_payment.setText(formattedTotalPayment);
    }
